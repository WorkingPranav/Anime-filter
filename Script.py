class script(object):  
    START_TXT = """<b>✨Hey there, {user}! 
🌟 I'm your personal anime genie. Rub the virtual lamp and let me grant you some anime wishes!",

I Cᴀɴ Pʀᴏᴠɪᴅᴇ Aɴɪᴍᴇ Fᴏʀ Yᴏᴜ Jᴜsᴛ Aᴅᴅ Mᴇ Iɴ Yᴏᴜʀ Gʀᴏᴜᴘ Oʀ Jᴏɪɴ Oᴜʀ Gʀᴏᴜᴘ</b>"""
